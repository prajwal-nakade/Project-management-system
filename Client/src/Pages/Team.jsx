...
import { Search, Mail, Trash2, Users } from "lucide-react";
...
const Team = () => {
  ...
  const fetchMembers = async () => {
    try {
      ...
      const res = await axios.get(
        "https://project-management-system-vvva.vercel.app/api/team",
        {
          headers: {
  ...
  const handleDelete = async (id) => {
    try {
      ...
      await axios.delete(
        `https://project-management-system-vvva.vercel.app/api/team/${id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-neutral-500 mt-1">Manage your project team</p>
          </div>
